...
### Install `gnrs` using pip
   ...
   >
   > `rigid_press` extension links against BLAS and LAPACK (`-llapack -lblas` by default). On HPC systems where library names differ (e.g., [TACC Vista](https://docs.tacc.utexas.edu/hpc/vista/#compiler-examples)), edit the `libraries` and `library_dirs` fields of the `rigid_press` extension in [`setup.py`](./setup.py).
   >
   > See the [installation guide](https://yi5817.github.io/Genarris/user/install) for more details.
...
For the full list of related papers, see the [Citation](https://yi5817.github.io/Genarris/about/citation.html) page.
